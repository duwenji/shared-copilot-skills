...
| invoke-ebook-step2-cover.ps1 | `cover.pdf`, `cover.jpg` | 生成物依存 | Step3 の必須入力 |
...
Select-String -Path ./scripts/invoke-ebook-step3-finalize.ps1 -Pattern 'manuscript\.md|cover\.pdf|cover\.jpg'
```
